...
import progen.kernel.functions.ShiftUnsignedRight;
 ...
 * @since 2.0
 */
public class ShiftUnsignedRightTest{

	private ShiftUnsignedRight shift;
	
	@Before
	public void setUp(){
		shift=new ShiftUnsignedRight();
	}
	...
	public void evaluateTest(){
		...
		IntN x =new IntN();
		x.setValue(0x8);
		GrammarTerminalSymbol x1 = new GrammarTerminalSymbol(x);
		IntM y =new IntM();
		y.setValue(0x2);
		...
		a.setFunction(x1);
		b.setFunction(x2);
		assertEquals(0x2, (Integer)shift.evaluate(arguments, userProgram, returnAddr), 0);
