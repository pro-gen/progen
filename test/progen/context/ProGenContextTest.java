...
import progen.context.MalformedParameterException;
...
public class ProGenContextTest {
	...
	ProGenContext.setProperty("mandatory.string",
		"Lorem ipsum dolor sit amet");
	ProGenContext.setProperty("mandatory.percent.string", "99%");
	ProGenContext.setProperty("mandatory.percent.double", "0.75");
	ProGenContext.setProperty("suboptional.percent",
		"option(suboption1=0.60,suboption2=40%)");
	ProGenContext.setProperty("option.suboptions",
