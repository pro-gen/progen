...
import progen.kernel.functions.AndInconditional;
 ...
 * @since 2.0
 */
public class AndInconditionalTest {

  private AndInconditional and;

  @Before
  public void setUp() {
    and = new AndInconditional();
  }

  @Test
  public void andInconditionalTest() {
