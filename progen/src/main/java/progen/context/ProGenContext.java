...
public class ProGenContext {
	...
	/**
	 * Devuelve el valor concreto de un parámetro de configuración de una
	 * opción. En caso de que no exista la opción o la subopción de la que se
	 * quiere obtener el valor, se devolverá el valor null; y en caso de que
	 * haya algún parámetro no definido según la forma indicada a continuación,
	...
	public static Map<String, String> getParameters(String option) {
		...
		if (parametersContext != null
				&& parametersContext.split(parametersDelim).length > 1) {
			...
			try {
				...
				throw new MalformedParameterException(option + ","
						+ parameterKey);
			}
		}
		return parameters;
