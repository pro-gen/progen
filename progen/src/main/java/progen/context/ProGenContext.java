...
public class ProGenContext {
   ...
   * aplicación.
   *
   * @param file Fichero maestro de donde se cargarán los distintos valores de
   *             configuración.
   * @return La instancia desde la que se podrán recuperar las opciones
   * definidas.
   * @throws MissingContextFileException En caso de que no se encuentre el fichero maestro de
   ...
   * @param defaultPercent El porcentaje por defecto, en caso de que no exista esta
   *                       subopción.
   ...
   * @param defaultPercent El valor por defecto en caso de no haberse definido la
   *                       propiedad.
   ...
   * </code>
   *
   * @param option    Opción de la que se obtendrá un parámetro.
   * @param parameter Parámetro de la que se quiere obtener un valor concreto.
