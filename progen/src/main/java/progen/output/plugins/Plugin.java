...
/**
 * Interfaz que representa la cabeza en la jeraquía de Plugins. Se definen todos
 * los métodos que tendrán que implementar los distintos tipos de plugins.
 * 
 * @author jirsis
 * @since 2.0
 */
public interface Plugin {
  /**
   * Función que se utilizará para ir calculando los valores que terminará
   * ofreciendo el plugin.
   * 
   * @param value
   *          El valor a añadir.
   */
   ...
   * es un plugin que no depende del cálculo de ningún otro, devolverá 0, sino,
   * tendrá que devolver un numero mayor, en función de los plugins de los que
   * dependa. Por ejemplo, el plugin Mean, es independiente, por lo que
   * devolverá 0, sin embargo, Variance depende de éste, por lo tanto devolverá
   * un valor mayor o igual que 1, si hubiera algún plugin que dependiera de
   * Variance, éste último, tendría que devolver un valor mayor que el devuelto
   * por Variance.
   * 
   ...
   * configuración definida. Recibe una cadena que identifica la familia de
   * propiedades que hacen referencia a este plugin.
   * 
   ...
   * NullPlugin, en caso de no conocer el plugin.
   * 
   * @param name
   ...
   * calcular el actual. En caso de que falte alguno, será necesario añadirlo a
   * la colección.
   * 
