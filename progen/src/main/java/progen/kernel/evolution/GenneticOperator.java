...
/**
 * Clase que define los métodos de acceso a los distintos operadores genéticos
 * disponibles.
 * 
 * @author jirsis
 * @since 2.0
...
public abstract class GenneticOperator {
   ...
   * 
   * @param probability
   *          La porbabilidad con la que será usado.
   */
  ...
  /**
   * Define el selector que utilizará el operador genético para escoger los
   * inidividuos.
   * 
   * @param name
   *          El nombre del selector.
   * @param params
   *          Parámetros de configuración del selector.
   */
   ...
   * 
   * @param population
   *          La población sobre la que se aplicará el operador.
