...
/**
 * Clase que implementa el operador de menor que (<) de dos variable enteras.
 * 
 * @author jirsis
 * @since 2.0
 */
public class IntLessThan extends NonTerminal {

  private static final long serialVersionUID = -1345705575300707242L;
