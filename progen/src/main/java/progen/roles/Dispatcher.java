 ...
 * recibir información de un <code>Client</code> y repartirla a los
 * <code>Worker</code> que calcularán las tareas.
 * 
 * @author jirsis
 * @see Client
 * @see Worker
...
public interface Dispatcher extends ExecutionRole {
  /**
   * Método que es el encargado de recibir el conjunto de tareas a evaluar y la
   * función de evaluación de dichas tareas.
   * 
   * @param tasks
   *          Conjunto de tareas a evaluar.
   * @param userProgram
